    ...
    document.getElementById("header-lang-img") &&
      ("en" == e
        ? (document.getElementById("header-lang-img").src =
            "/theme/assets/images/flags/us.svg")
        : "sp" == e
        ? (document.getElementById("header-lang-img").src =
            "/theme/assets/images/flags/spain.svg")
        : "gr" == e
        ? (document.getElementById("header-lang-img").src =
            "/theme/assets/images/flags/germany.svg")
        : "it" == e
        ? (document.getElementById("header-lang-img").src =
            "/theme/assets/images/flags/italy.svg")
        : "ru" == e
        ? (document.getElementById("header-lang-img").src =
            "/theme/assets/images/flags/russia.svg")
        : "ch" == e
        ? (document.getElementById("header-lang-img").src =
            "/theme/assets/images/flags/china.svg")
        : "fr" == e &&
          (document.getElementById("header-lang-img").src =
            "/theme/assets/images/flags/french.svg"),
      localStorage.setItem("language", e),
      (b = localStorage.getItem("language")),
      (function () {
        null == b && y(g);
        var e = new XMLHttpRequest();
        e.open("GET", "/theme/assets/lang/" + b + ".json"),
  ...
  function h() {
    ...
    !a ||
      ...
      ((o = document.createElement("ul")).innerHTML =
        '<a href="#" class="logo"><img src="/theme/assets/images/logo-sm.png" alt="" height="22"></a>'),
      document
