var minCostInput,
  maxCostInput,
  slider = document.getElementById("product-price-range");
slider &&
    ...
    columns: [
      ...
      },
      {
        ...
        formatter: function (e) {
          return gridjs.html(
            '<div class="d-flex align-items-center"><div class="flex-shrink-0 me-3"><div class="avatar-sm bg-light rounded p-1"><img src="/theme/assets/images/products/' +
              e[0] +
...
var TableProductListPublished = document.getElementById(
  "table-product-list-published"
);
TableProductListPublished &&
  new gridjs.Grid({
    columns: [
      {
