  ...
  document.getElementById("sa-image") &&
    document.getElementById("sa-image").addEventListener("click", function () {
      Swal.fire({
        ...
        imageUrl: "/theme/assets/images/logo-sm.png",
        imageHeight: 40,
        confirmButtonClass: "btn btn-primary w-xs mt-2",
        buttonsStyling: !1,
        animation: !1,
    ...
    document
      ...
      .addEventListener("click", function () {
        Swal.fire({
          ...
          html:
            '<div class="mt-3 text-start"><label for="input-email" class="form-label fs-13">Email</label><input type="email" class="form-control" id="input-email" placeholder="Enter Email Address"></div>',
          imageUrl: "/theme/assets/images/logo-sm.png",
          footer:
  ...
  document.getElementById("custom-sa-notification") &&
    document
      ...
      .addEventListener("click", function () {
        Swal.fire({
          html:
            '<div class="mt-3"><div class="avatar-lg mx-auto"><img src="/theme/assets/images/users/avatar-2.jpg" class="rounded-circle img-thumbnail" alt="thumbnail"></div><div class="mt-4 pt-2 fs-15"><h4 class="fs-18 fw-semibold">Welcome <span class="fw-semibold">Mike Mayer</span></h4><p class="text-muted mb-0 fs-13">You have <span class="fw-semibold text-success">2</span> Notifications</p></div></div>',
          showCancelButton: !1,
          confirmButtonClass: "btn btn-primary mb-1",
          confirmButtonText:
