...
(xhttp.onload = function () {
  ...
  xhttp.open("GET", "/theme/assets/json/support-tickets-list.json"),
  xhttp.send(),
...
function deleteMultiple() {
  if (
    ((ids_array = []),
    document
      .querySelectorAll(".form-check [value=option1]")
      .forEach(function (e) {
        1 == e.checked &&
    ...
    ids_array.forEach(function (e) {
      ticketsList.remove(
        "id",
        `<a href="javascript:void(0);" onclick="ViewTickets(this)" data-id="${e}" class="fw-medium link-primary ticket-id">#VLZ${e}</a>`
      );
    }),
