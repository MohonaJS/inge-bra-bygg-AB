...
(xhttp.onload = function () {
  ...
  xhttp.open("GET", "/theme/assets/json/orders-list.init.json"),
  xhttp.send(),
...
function SearchData() {
  ...
  orderList.filter(function (e) {
    ...
    var t = matchData.body.firstElementChild.innerHTML,
      ...
      l = !1,
      a = "all" == t || "all" == d || t == d,
      n = "all" == e.values().payment || "all" == s || e.values().payment == s,
      l =
...
function deleteMultiple() {
  if (
    ...
    document
      ...
      .forEach(function (e) {
        1 == e.checked &&
          ((e = e.parentNode.parentNode.parentNode.querySelector("td a")
            .innerHTML),
          ids_array.push(e));
      }),
